...
const TINY_PNG: &[u8] = &[
    ...
    0x73, 0x00, 0x00, 0x00, 0x10, 0x49, 0x44, 0x41, 0x54, 0x78, 0x9c, 0x63, 0x38, 0x21, 0x07, 0x04,
    0x27, 0x18, 0x20, 0x14, 0x00, 0x1c, 0x7e, 0x04, 0x11, 0xb3, 0x9e, 0x82, 0x94, 0x00, 0x00, 0x00,
...
#[test]
fn dump() {
    let pdf = markion_pdf::render(&representative_document()).expect("render");
    let dir = std::path::PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../../target/tmp");
    std::fs::create_dir_all(&dir).unwrap();
    let path = dir.join("markion-pdf-engine-sample.pdf");
