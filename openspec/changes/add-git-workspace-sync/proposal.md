...
- Supersession note (2026-09-22, before archive): `simplify-git-setup-dialog-choices` replaced the "alternative routes behind a secondary choice" presentation with directly visible routes and a preselected recommendation, following user feedback; the git-workspace delta above carries the reconciled wording.
