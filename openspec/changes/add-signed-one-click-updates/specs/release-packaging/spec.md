...
#### Scenario: User invokes Check for Updates and a signed Windows update is available
...
#### Scenario: Update discovery fails without crashing
...
#### Scenario: Update work does not alter cached Markdown state
