...
- **AND** a scrollable panel region (General tab body, Theme tab body, Shortcuts category sidebar, Shortcuts action list, or Export tab body) contains more content than fits its visible area
