...
- [x] 5.4 Confirmed by a human in the running app on a machine with a display: the Mermaid feature was verified after merging `feature-mermaid` into `main`, so Split Preview and Read mode render correctly.
