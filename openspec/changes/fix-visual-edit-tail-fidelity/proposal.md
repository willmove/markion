...
- The caret on a trailing whitespace row tracks the insertion line (not the row origin), and after a caret-moving edit the list pixel-follows the painted caret so last-line typing and repeated Enter cannot grow below the viewport clip.
