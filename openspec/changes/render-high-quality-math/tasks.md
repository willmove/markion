...
- [ ] 7.4 Complete visual QA in light/dark themes at representative zoom and display scales and verify the supported Windows, macOS, and Linux CI/release target matrix before marking the change complete.
