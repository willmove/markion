...
#### Scenario: Diagram fence language token is editable while the fence owns the caret
- **WHEN** a diagram fence owns the caret and the user edits the language label in its payload-editor header
