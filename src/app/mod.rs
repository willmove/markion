...
use markion::{
    ...
    SlashCommand, SlashQuery, SupportedPathKind, TableEdit, ThemeColors, ThemeDefinition,
    ThemeFonts, ViewMode, VisualBlock, VisualBlockEditor, VisualBlockId, VisualBlockKind,
    ...
    WorkspaceSnapshot, adjacent_reorder_target, authored_table_column_percents, auto_pair_action,
    backend_status_msg, block_can_reorder_at, block_can_transform_at, build_image_application_plan,
    ...
    clamp_image_width_percent, classify_supported_path, data_uri_payload_ranges,
    ...
    diagram_backend_id, duplicate_block, elided_payload_token, emoji_confirm_replacement,
    emoji_query_at, emoji_shortcodes_matching, highlight_code, html_preview_parts,
    html_preview_plain_text, html_table_column_weights, html_table_grid_line_end,
    html_table_row_has_visible_header, image_extension_supported, inline_image_at, inline_link_at,
    inspect_recovery_files, is_auto_pair_restricted_field, is_markdown_path, is_text_path,
    layout_rect_is_visible, list_theme_definitions, load_app_preferences, load_recovery_file,
    ...
    p1_t, p1_tf, pandoc_available, percents_from_flex_weights, read_document_source,
    redistribute_adjacent_column_percents, reorder_block, resolve_font_family,
    ...
    sidebar_tab_label, slash_command_edit, slash_query_at, snap_image_width_percent, t,
    table_column_flex_weights, table_column_flex_weights_with_authored,
    table_column_width_prefix_len, task_checkbox_toggle, tf, title_from_path, transform_block,
...
struct MarkionApp {
    ...
    /// Additive `[git]` preferences. Repository policy is deliberately kept
    /// outside this resettable global preferences value.
