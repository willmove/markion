...
pub enum Msg {
    ...
    /// {0}=new path.
    StatusFileTreeDuplicated,
    /// {0}=error.
    StatusFileTreeDuplicateFailed,
    ...
    FileTreeContextDuplicate,
    /// Localized copy-name marker inserted as `{stem} - {marker}{ext}`.
    FileTreeDuplicateMarker,
...
pub fn shortcut_catalog(lang: Language, heading_menu_max_level: u8) -> ShortcutCatalog {
    ...
    editing.actions.splice(
        ...
        [
            ...
            ShortcutAction {
                label: t(lang, Msg::ItemPastePlain),
                ids: &["paste-plain"],
                windows_linux: &["Ctrl+Alt+V"],
                macos: &["Cmd+Option+V"],
            },
            ShortcutAction {
...
fn en(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemCut => "Cut",
        Msg::ItemPaste => "Paste",
        Msg::ItemPastePlain => "Paste as Plain Text",
        ...
        Msg::StatusFileTreeDuplicated => "Duplicated {0}",
        Msg::StatusFileTreeDuplicateFailed => "Could not duplicate: {0}",
...
{0}"
        ...
        Msg::FileTreeContextDuplicate => "Duplicate",
        Msg::FileTreeDuplicateMarker => "copy",
...
fn ja(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemCut => "切り取り",
        Msg::ItemPaste => "貼り付け",
        Msg::ItemPastePlain => "プレーンテキストとして貼り付け",
        ...
        Msg::StatusFileTreeDuplicated => "{0} の複製を作成しました",
        Msg::StatusFileTreeDuplicateFailed => "複製を作成できませんでした: {0}",
...
{0}"
        ...
        Msg::FileTreeContextDuplicate => "複製を作成",
        Msg::FileTreeDuplicateMarker => "コピー",
...
fn fr(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemPastePlain => "Coller sans mise en forme",
        ...
        Msg::StatusFileTreeDuplicated => "Copie créée : {0}",
        Msg::StatusFileTreeDuplicateFailed => "Impossible de créer la copie : {0}",
...
{0}"
        ...
        Msg::FileTreeContextDuplicate => "Créer une copie",
        Msg::FileTreeDuplicateMarker => "copie",
...
fn de(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemPastePlain => "Als unformatierten Text einfügen",
        ...
        Msg::StatusFileTreeDuplicated => "Duplikat erstellt: {0}",
        Msg::StatusFileTreeDuplicateFailed => "Duplikat fehlgeschlagen: {0}",
...
{0}"
        ...
        Msg::FileTreeContextDuplicate => "Duplikat erstellen",
        Msg::FileTreeDuplicateMarker => "Kopie",
...
fn es(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ItemCut => "Cortar",
        Msg::ItemPaste => "Pegar",
        Msg::ItemPastePlain => "Pegar como texto sin formato",
        ...
        Msg::StatusFileTreeDuplicated => "Copia creada: {0}",
        Msg::StatusFileTreeDuplicateFailed => "No se pudo crear la copia: {0}",
...
{0}"
        ...
        Msg::FileTreeContextDuplicate => "Crear copia",
        Msg::FileTreeDuplicateMarker => "copia",
...
fn zh(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::StatusFileTreeDuplicated => "已创建副本 {0}",
        Msg::StatusFileTreeDuplicateFailed => "创建副本失败：{0}",
...
{0}"
        ...
        Msg::FileTreeContextDuplicate => "创建副本",
        Msg::FileTreeDuplicateMarker => "副本",
...
fn zh_hant(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::StatusFileTreeDuplicated => "已建立複本 {0}",
        Msg::StatusFileTreeDuplicateFailed => "建立複本失敗：{0}",
...
{0}"
        ...
        Msg::FileTreeContextDuplicate => "建立複本",
        Msg::FileTreeDuplicateMarker => "複本",
...
mod tests {
    ...
    fn every_message_returns_non_empty_text_for_every_language() {
        ...
        let all = [
            ...
            Msg::FileTreeContextDuplicate,
            Msg::FileTreeDuplicateMarker,
