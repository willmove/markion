...
fn en(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::PdfErrorRuntimeMissing => "The bundled PDF renderer is missing.",
        Msg::PdfErrorRuntimeUnavailable => "The PDF renderer could not be started.",
...
fn ja(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::PdfErrorRuntimeMissing => "同梱のPDFレンダラーが見つかりません。",
        Msg::PdfErrorRuntimeUnavailable => "PDFレンダラーを起動できませんでした。",
...
fn fr(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::PdfErrorRuntimeMissing => "Le moteur PDF intégré est absent.",
        Msg::PdfErrorRuntimeUnavailable => "Le moteur PDF n’a pas pu démarrer.",
...
fn de(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::PdfErrorRuntimeMissing => "Die mitgelieferte PDF-Engine fehlt.",
        Msg::PdfErrorRuntimeUnavailable => "Die PDF-Engine konnte nicht gestartet werden.",
...
fn es(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::PdfErrorRuntimeMissing => "Falta el motor PDF incluido.",
        Msg::PdfErrorRuntimeUnavailable => "No se pudo iniciar el motor PDF.",
...
fn zh(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::PdfErrorRuntimeMissing => "缺少随应用提供的 PDF 渲染器。",
        Msg::PdfErrorRuntimeUnavailable => "无法启动 PDF 渲染器。",
...
fn zh_hant(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::PdfErrorRuntimeMissing => "缺少隨應用程式提供的 PDF 轉譯器。",
        Msg::PdfErrorRuntimeUnavailable => "無法啟動 PDF 轉譯器。",
